/*
In a almost infinity grid(1e10*1e10), there are n segments which is either verticle or horizontal.
You need to calculate how many grids are on the segment or inner some segments (such as in a rectangle).

Just discrete the segment and bfs how many grids are outside.
*/
#include <cstdlib>
#include <cctype>
#include <cstring>
